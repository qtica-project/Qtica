...
class _WaterProgressBar(QProgressBar):
    def __init__(self, 
        ...
        super(_WaterProgressBar, self).__init__()
    ...
    def on_timeout(self):
        ...
        for pop in self.pops:
            # yOffset 0 ~ 100
            pop.y_offset += speed * pop.y_speed
            if pop.y_offset < 0:
                pass

            if pop.y_offset > self.value():
                pop.y_offset = 0

            pop.x_offset = math.sin((pop.y_offset / 100) * 2 * 3.14) * 18 * pop.x_speed + 50
    ...
    def paint(self, painter):
        ...
        if self.value() > 30:
            for pop in self.pops:
                ...
                popPath.addEllipse(pop.x_offset * sz.width() / 100, (100 - pop.y_offset) * sz.height() / 100,
